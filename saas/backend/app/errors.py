"""
Purpose: Define project-specific exceptions for Tesla auth, invoice download and delivery flows.
...
Debug: Start by checking the exact exception class because it tells you whether the problem is user input, Tesla auth, API reachability or file handling.
"""
